 ...
 */
@WebServlet(description = "prikaz profesora", urlPatterns = { "/PrikaziProfesoreController" })
public class PrikaziProfesoreController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// preko RequestDispatcher odredjujemo putanju gde cemo da prosledimo ovu listu
